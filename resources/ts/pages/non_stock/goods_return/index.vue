...
const validateTanggalFilter = async (
  ...
  if (
    ...
    showErrorToast({
      title: t('goodsReturn.list.toast.invalidDateRangeTitle'),
      text: t('goodsReturn.list.toast.invalidStartDateText'),
    })
  ...
  if (
    ...
    showErrorToast({
      title: t('goodsReturn.list.toast.invalidDateRangeTitle'),
      text: t('goodsReturn.list.toast.invalidEndDateText'),
    })
  }
}
    ...
    */
    ...
    showErrorToast({
      ...
      text: getApiErrorMessage(
        err,
        t('goodsReturn.list.toast.loadFailed'),
      ),
    })
...
const goToEdit = (
  ...
  router.push(
    `/non_stock/goods_return/edit?id=${encodeURIComponent(publicId)}`,
  )
}
...
const openDetail = async (
  ...
  if (!publicId) {
    showErrorToast({
      title: t('common.alert.error'),
      text: t('goodsReturn.list.toast.detailNotFoundText'),
    })
  ...
  try {
    ...
    showLoadingAlert(
      t('goodsReturn.list.toast.detailLoadingTitle'),
    ...
    showErrorToast({
      ...
      text: getApiErrorMessage(
        err,
        t('goodsReturn.list.toast.detailLoadFailed'),
      ),
    })
  }
}
...
const openDelete = async (
  ...
  if (
    ...
    showErrorToast({
      title: t('goodsReturn.list.toast.deleteNotAllowedTitle'),
      text: t('goodsReturn.list.toast.deleteNotAllowedText'),
    })
  ...
  const confirm = await showConfirmAlert({
    icon: 'question',
    title: t('goodsReturn.list.toast.deleteConfirmTitle'),
    html: t('goodsReturn.list.toast.deleteConfirmHtml', { nomor: row.nomor_return || '-' }),

    confirmButtonText: t('goodsReturn.list.toast.deleteConfirmButton'),
  ...
  try {
    showLoadingAlert(
      t('goodsReturn.list.toast.deleteLoading'),
      t('common.alert.pleaseWait'),
    )
    ...
    if (response.data?.success) {
      showSuccessToast({
        ...
        text:
          ...
          || t('goodsReturn.list.toast.deleteSuccessFallback', { nomor: row.nomor_return }),
      })
    ...
    showErrorToast({
      ...
      text:
        response.data?.message
        || t('goodsReturn.list.toast.deleteFailedFallback'),
    })
  }
  catch (error: unknown) {
    closeAlert()
...
const postGoodsReturn = async (
  ...
  if (!row.public_id) {
    showErrorToast({
      title: t('common.alert.error'),
      text: t('goodsReturn.list.toast.postNotFoundText'),
    })
  ...
  if (
    ...
    showErrorToast({
      title: t('goodsReturn.list.toast.postNotAllowedTitle'),
      text: t('goodsReturn.list.toast.postNotAllowedText'),
    })
  ...
  const confirm = await showConfirmAlert({
    title: t('goodsReturn.list.toast.postConfirmTitle'),

    text: t('goodsReturn.list.toast.postConfirmText', { nomor: row.nomor_return }),

    confirmButtonText: t('goodsReturn.list.toast.postConfirmButton'),
    cancelButtonText: t('common.actions.cancel'),
    icon: 'question',
  })
  ...
  try {
    showLoadingAlert(
      t('goodsReturn.list.toast.postLoading'),
      t('common.alert.pleaseWait'),
    )
    ...
    showSuccessToast({
      title: t('common.alert.success'),
      text: t('goodsReturn.list.toast.postSuccessFallback', { nomor: row.nomor_return }),
    })
    ...
    showErrorToast({
      ...
      text: getApiErrorMessage(
        err,
        t('goodsReturn.list.toast.postFailed'),
      ),
    })
  }
}
...
const openCancelDialog = (
  ...
  if (
    ...
    showErrorToast({
      title: t('goodsReturn.list.toast.cancelNotAllowedStatusTitle'),
      text: t('goodsReturn.list.toast.cancelNotAllowedStatusText'),
    })
  ...
  if (row.has_replacement_gr) {
    showErrorToast({
      title: t('goodsReturn.list.toast.cancelNotAllowedReplacementTitle'),
      text: t('goodsReturn.list.toast.cancelNotAllowedReplacementText'),
    })
...
const submitCancel = async (): Promise<void> => {
  ...
  if (!notes) {
    showErrorToast({
      title: t('goodsReturn.list.toast.cancelReasonRequiredTitle'),
      text: t('goodsReturn.list.toast.cancelReasonRequiredText'),
    })
  ...
  */
  ...
  const confirmation = await showConfirmAlert({
    icon: 'warning',
    title: t('goodsReturn.list.toast.cancelConfirmTitle'),

    html: t('goodsReturn.list.toast.cancelConfirmHtml', { nomor: row.nomor_return || '-' }),

    confirmButtonText: t('goodsReturn.list.toast.cancelConfirmButton'),
    cancelButtonText: t('goodsReturn.list.toast.cancelConfirmBackButton'),
  })
  ...
  */
  ...
  try {
    showLoadingAlert(
      t('goodsReturn.list.toast.cancelLoading'),
      t('common.alert.pleaseWait'),
    )
    ...
    */
    ...
    showSuccessToast({
      ...
      text:
        response.data?.message
        || t('goodsReturn.list.toast.cancelSuccessFallback'),
    })
    ...
    showErrorToast({
      ...
      text: getApiErrorMessage(
        err,
        t('goodsReturn.list.toast.cancelFailed'),
      ),
    })
  ...
  if (success) {
    ...
    setTimeout(() => {
      if (success === 'created') {
        showSuccessToast({
          title: t('common.alert.success'),
          text: t('goodsReturn.list.toast.createdSuccess'),
        })
      }
      ...
      if (success === 'updated') {
        showSuccessToast({
          title: t('common.alert.success'),
          text: t('goodsReturn.list.toast.updatedSuccess'),
        })
      }
    }, 300)
  }
      ...
      <VCardText class="pa-5">
        <div class="d-flex align-center justify-space-between flex-wrap gap-3 mb-4">
          <div class="d-flex align-center gap-3">
            ...
            <div>
              <div class="text-subtitle-1 font-weight-bold">
                {{ t('goodsReturn.list.filtersTitle') }}
              </div>

              <div class="text-caption text-medium-emphasis">
                {{ t('goodsReturn.list.filtersSubtitle') }}
              </div>
            </div>
          </div>
          ...
          <VBtn
            ...
            @click="resetFilters"
          >
            {{ t('goodsReturn.list.filters.resetButton') }}
          </VBtn>
        </div>
        ...
        <VRow class="align-center">
          ...
          >
            <VTextField
              v-model="searchQuery"
              :label="t('goodsReturn.list.filters.searchLabel')"
              :placeholder="t('goodsReturn.list.filters.searchPlaceholder')"
              density="compact"
              clearable
              hide-details="auto"
          ...
          >
            <AppDateTimePicker
              ...
              :label="t('goodsReturn.list.filters.startDate')"
              density="compact"
              clearable
              hide-details="auto"
              :config="{
          ...
          >
            <AppDateTimePicker
              ...
              :label="t('goodsReturn.list.filters.endDate')"
              density="compact"
              clearable
              hide-details="auto"
              :config="{
          ...
          >
            <VSelect
              ...
              :label="t('goodsReturn.list.filters.statusLabel')"
              :items="statusItems"
              item-title="title"
              item-value="value"
              density="compact"
    ...
    <VCard>
      <VCardText class="d-flex flex-wrap gap-4 align-center">
        <VBtn
          ...
          @click="goToCreate"
        >
          {{ t('goodsReturn.list.createButton') }}
        </VBtn>
        ...
        <div class="d-flex align-center gap-2">
          <VChip
            ...
            variant="tonal"
          >
            {{ t('goodsReturn.list.toast.loadingText') }}
          </VChip>
          ...
          >
            {{ t('goodsReturn.list.toast.reloadData') }}
          </VBtn>
        </div>
      </VCardText>
      ...
      <VTable class="text-no-wrap">
        <thead>
          <tr>
            ...
            >
              {{ t('goodsReturn.list.table.nomorReturn') }}
            </th>
            ...
            <th
              ...
              class="text-center"
            >
              {{ t('goodsReturn.list.table.tanggal') }}
            </th>
            ...
            <th
              ...
              class="text-center"
            >
              {{ t('goodsReturn.list.table.nomorGr') }}
            </th>
            ...
            <th
              ...
              class="text-center"
            >
              {{ t('goodsReturn.list.table.vendor') }}
            </th>
            ...
            <th
              ...
              class="text-center"
            >
              {{ t('goodsReturn.list.table.status') }}
            </th>
            ...
            <th
              ...
              style="width: 5rem;"
            >
              {{ t('goodsReturn.list.table.actions') }}
            </th>
          </tr>
        </thead>
