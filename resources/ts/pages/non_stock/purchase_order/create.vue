  ...
  try {
    ...
    if (showAlert) {
      showErrorToast({
        ...
        text: getApiErrorMessage(error, t('purchaseOrder.create.toast.loadVendorFailed')),
      })
    }
  } finally {
...
const fetchCabangList = async (showAlert = true): Promise<void> => {
  ...
  try {
    ...
    if (showAlert) {
      showErrorToast({
        title: t('common.alert.error'),
        text: getApiErrorMessage(error, t('purchaseOrder.create.toast.loadCabangFailed')),
      })
    }
  } finally {
    ...
    if (showAlert) {
      showErrorToast({
        ...
        text: getApiErrorMessage(
          error,
          t('purchaseOrder.create.toast.loadDepartmentFailed'),
        ),
      })
    }
  }
...
const loadPurchaseRequestsByFilter = async (): Promise<void> => {
  ...
  try {
    ...
    showErrorToast({
      ...
      text: getApiErrorMessage(
        error,
        t('purchaseOrder.create.toast.loadPrFailed'),
      ),
    })
  }
  finally {
...
const openPurchaseRequestDetail = async (publicId: string): Promise<void> => {
  ...
  try {
    ...
    showErrorToast({
      title: t('common.alert.error'),
      text: getApiErrorMessage(error, t('purchaseOrder.create.toast.loadPrDetailFailed')),
    })
  }
}
...
const confirmCancel = async (): Promise<void> => {
  const confirm = await showConfirmAlert({
    icon: 'question',
    title: t('purchaseOrder.create.toast.cancelConfirmTitle'),
    text: t('purchaseOrder.create.toast.cancelConfirmText'),
...
const validateForm = async (): Promise<boolean> => {
  ...
  if (
    ...
    showErrorToast({
      ...
      text: t('purchaseOrder.create.toast.departmentNotAllowedText'),
    })
  ...
  if (selectedPurchaseRequestsWithoutItem.length > 0) {
    ...
    showWarningToast({
      title: t('common.alert.warning'),
      text: t('purchaseOrder.create.toast.prWithoutItemsWarning', { list: nomorPrList }),
    })
  ...
  if (invalidItemIndex !== -1) {
    ...
    showWarningToast({
      title: t('common.alert.warning'),
      text: t('purchaseOrder.create.toast.invalidQtyWarning', { item: item.nama_item || '-' }),
    })
...
const savePurchaseOrder = async (): Promise<void> => {
  ...
  const confirm = await showConfirmAlert({
    icon: 'question',
    title: t('purchaseOrder.create.toast.saveConfirmTitle'),
    text: t('purchaseOrder.create.toast.saveConfirmText'),
  ...
  try {
    showLoadingAlert(t('purchaseOrder.form.savingData'), t('common.alert.pleaseWait'))
    ...
    showErrorToast({
      title: t('common.alert.error'),
      text: getApiErrorMessage(error, t('purchaseOrder.create.toast.saveFailed')),
    })
  } finally {
...
onMounted(async () => {
  ...
  if (!hasDepartmentAccess) {
    showErrorToast({
      title: t('purchaseOrder.create.toast.departmentUnavailableTitle'),
      text:
        createPermissionScope.value
          === 'OWN_DEPARTMENT'
          ? t('purchaseOrder.create.toast.departmentUnavailableOwn')
          : createPermissionScope.value
            === 'ASSIGNED_DEPARTMENTS'
            ? t('purchaseOrder.create.toast.departmentUnavailableAssigned')
            : createPermissionScope.value
              === 'ALL'
              ? t('purchaseOrder.create.toast.departmentUnavailableAll')
              : t('purchaseOrder.create.toast.departmentUnavailableDefault'),
    })
  }
      ...
      <VCardTitle class="d-flex align-center justify-space-between">
        <div>
          <div class="text-h6 font-weight-bold">
            {{ t('purchaseOrder.form.createTitle') }}
          </div>
          <div class="text-body-2 text-medium-emphasis">
            {{ t('purchaseOrder.form.createSubtitle') }}
          </div>
        </div>
      ...
      <VCardText>
            ...
            >
              <template #append-inner>
                <VTooltip
                  ...
                  :text="t('purchaseOrder.reload.cabang')"
                  location="top"
                >
              ...
              <VTable class="border rounded">
                <thead>
                  <tr>
                    ...
                    <th>{{ t('purchaseOrder.prSection.tableNomorPr') }}</th>
                    <th>{{ t('purchaseOrder.prSection.tableLampiran') }}</th>
                    <th class="text-center">{{ t('purchaseOrder.prSection.tableTanggal') }}</th>
                    <th class="text-center">{{ t('purchaseOrder.prSection.tableCabang') }}</th>
                    <th class="text-center">{{ t('purchaseOrder.prSection.tableDepartment') }}</th>
                    <th class="text-end">{{ t('purchaseOrder.prSection.tableTotalPr') }}</th>
                  </tr>
                </thead>
                ...
                <tbody>
                  ...
                  <tr v-else-if="!purchaseRequestList.length">
                    <td colspan="7" class="text-center text-medium-emphasis py-6">
                      {{ t('purchaseOrder.prSection.emptyCreate') }}
                    </td>
                  </tr>
            ...
            <VCard variant="tonal">
              <VCardText>
                ...
                <div class="d-flex justify-space-between">
                  <span>{{ t('purchaseOrder.summary.grandTotal') }}</span>
            ...
            >
              <template #append-inner>
                  ...
                  <VTooltip
                    ...
                    :text="t('purchaseOrder.reload.vendor')"
                    location="top"
                  >
                    <template #activator="{ props }">
                      <VBtn
        ...
        <div class="d-flex justify-end gap-3">
          ...
          <VBtn
            ...
            class="text-none"
          >
            {{ t('purchaseOrder.form.saveButton') }}
          </VBtn>
        </div>
      </VCardText>
    </VCard>
            ...
            <VRow>
              ...
              >
                ...
                >
                  <VCardText>
                    <div class="text-caption text-medium-emphasis mb-1">
                      {{ t('purchaseOrder.prDetail.grandTotalPr') }}
                    </div>
                ...
                >
                  <VCardText>
                    <div class="d-flex align-center justify-space-between flex-wrap gap-3 mb-4">
                      <div>
                        <div class="text-subtitle-1 font-weight-bold">
                          {{ t('purchaseOrder.prDetail.vendorTitle') }}
                        </div>

                        <div class="text-body-2 text-medium-emphasis">
                          {{ t('purchaseOrder.prDetail.vendorSubtitle') }}
                        </div>
                      </div>
                    ...
                    <VRow>
                      ...
                      >
                        <div class="info-box">
                          <div class="info-label">
                            {{ t('purchaseOrder.prDetail.namaVendor') }}
                          </div>
                      ...
                      >
                        <div class="info-box">
                          <div class="info-label">
                            {{ t('purchaseOrder.prDetail.jenisPembayaran') }}
                          </div>
                ...
                >
                  <VCardText>
                    <div class="pr-detail-tax-row">
                      <span>{{ t('purchaseOrder.prDetail.subtotalItem') }}</span>
                      <strong>
                    ...
                    <div class="pr-detail-tax-row pr-detail-tax-grand-total">
                      <span>{{ t('purchaseOrder.prDetail.grandTotalPr') }}</span>
                      <strong>
                        Rp {{ formatNumberWithoutRp(purchaseRequestDetailGrandTotal) }}
                      </strong>
                    </div>
                    ...
                    <div class="pr-detail-tax-row">
                      <span>{{ t('purchaseOrder.prDetail.totalSudahPo') }}</span>
                      <strong>
                    ...
                    <div class="pr-detail-tax-row pr-detail-tax-outstanding">
                      <span>{{ t('purchaseOrder.prDetail.totalOutstanding') }}</span>
                      <strong>
