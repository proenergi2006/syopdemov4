...
const saveCashAdvance = async (event?: Event): Promise<void> => {
  ...
  const confirm = await showConfirmAlert({
    title: t('cashAdvance.form.toast.saveConfirmTitle'),
    text: t('cashAdvance.form.toast.saveConfirmText'),
    confirmButtonText: t('common.actions.confirm'),
    cancelButtonText: t('common.actions.cancel'),
  })
  ...
  try {
     ...
     */
    await axios.post('/fund-request/cash-advance', buildFormData(), {
      headers: { Accept: 'application/json' },
    })
...
onMounted(async () => {
  ...
  /*
   * Baru setelah cabang dan department terisi -- daftar kategorinya memang
          ...
          <VCardTitle class="d-flex align-center justify-space-between flex-wrap gap-3">
            <div>
              <div class="text-h6 font-weight-bold">
                {{ t('cashAdvance.form.createTitle') }}
              </div>

              <div class="text-body-2 text-medium-emphasis">
                {{ t('cashAdvance.form.createSubtitle') }}
              </div>
            </div>
          ...
          <VCardText>
                ...
                >
                  <template #append-inner>
                    <VTooltip
                      ...
                      :text="t('cashAdvance.form.reload.branch')"
                      location="top"
                    >
            ...
            <div class="d-flex justify-end gap-3">
              ...
              <VBtn
                ...
                class="text-none"
                :loading="isSaving"
                @click.prevent.stop="saveCashAdvance($event)"
              >
                {{ t('cashAdvance.form.buttons.save') }}
              </VBtn>
            </div>
          </VCardText>
        </VCard>
